export default {
	...
	methods : {
		async getProductPurchases(){
			...
			await this.$axios.$get(`/products/${this.product.uuid}/purchases?include=product_variation,product_variation.product,product_variation.variation,created_by,supplier,purchase_invoice,reversed_by,payments&paginate=25${this.queryParameters}`)
			.then((res)=>{
