	...
	<div class="background">
		<div class="tiny-padding border-bottom uk-flex uk-flex-between">
			<div class="uk-width-expand uk-flex uk-flex-middle">
				...
				<h4 class="uk-margin-remove">Store Stock Report</h4>
			</div>
		...
		<div class="uk-flex uk-flex-column horizontal-scroll">
...
<script>
import {store} from "@/mixins/reports/stock" 
export default{
	head(){
		return {
			title : `${this.$appName} | ${this.emporium.name} - Store Stock Report`
		}
	},
	data(){
		return {
