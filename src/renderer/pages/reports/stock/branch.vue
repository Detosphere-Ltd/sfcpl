	...
	<div class="background">
		<div class="tiny-padding border-bottom uk-flex uk-flex-between">
			<div class="uk-width-expand uk-flex uk-flex-middle">
				...
				<h4 class="uk-margin-remove">Branch Stock Report</h4>
			</div>
		...
		<div class="tiny-padding border-bottom">
			<div class="uk-width-1-1 uk-flex uk-flex-bottom uk-flex-wrap">
				...
				<div class="uk-width-auto  uk-flex uk-flex-column uk-margin-right">
					<span class="text-small tiny-margin-bottom">Order By Criteria</span>
		...
		<section>
			<headers-reports-stock class="tiny-padding border-bottom" show-branch></headers-reports-stock>
					...
					<div v-else>
						<template v-if="stats && stats.length > 0">
							<div class="uk-width-1-1 uk-flex uk-flex-column">
								...
								<stock-branch-report class="tiny-padding"  v-for="(item,i) in stats" :key="i" :item="item" :class="i < (stats.length - 1) ? 'border-bottom' : ''">
								</stock-branch-report>
								...
								<div class="uk-width-1-1 uk-flex uk-flex-column uk-flex-center uk-flex-middle">
									<div class="uk-flex uk-flex-column uk-flex-center uk-flex-middle">
										...
										<p class="uk-text-center uk-margin-remove-top">
											Store stock report will be displayed here when available
										</p>
...
<script>
import {branches} from "@/mixins/reports/stock" 
export default{
	head(){
		return {
			title : `${this.$appName} | ${this.emporium.name} - Branches Stock Report`
		}
	},
	async fetch(){
