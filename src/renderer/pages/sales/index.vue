	...
	<div class="background">
		<div class="tiny-padding border-bottom">
			<div class="uk-width-expand uk-flex uk-flex-middle">
				...
				<h4 class="uk-margin-remove">Sales Transactions</h4>
			</div>
		</div>
		...
		<section class="ledger uk-width-1-1 horizontal-scroll uk-flex uk-flex-column" v-show="showLedger">
			...
			<div class="tiny-padding border-bottom">
				<headers-sales-branches></headers-sales-branches>
			</div>
					...
					<div v-else>
						<template v-if="allSales && allSales.length > 0">
							<div class="uk-width-1-1 uk-flex uk-flex-column">
								<sale-branch-record class="tiny-padding"  v-for="(sale,i) in allSales" :key="sale.uuid" :sale="sale" :class="i < (allSales.length - 1) ? 'border-bottom' : ''" @needs-to-refresh="loadSales">
								</sale-branch-record>
