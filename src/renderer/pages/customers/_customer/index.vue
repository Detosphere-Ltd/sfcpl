<template>
	<div class="uk-margin-large-bottom">
		<div>
			...
			<div class="uk-width-1-1 tiny-padding border-bottom uk-flex uk-flex-middle">
				...
				<h5 class="uk-margin-remove">Purchase History for {{customer.name}}</h5>
			</div>
			...
			<div class="tiny-padding border-bottom">
				<div class="uk-width-1-1 uk-flex uk-flex-middle">
					...
					<div class="uk-width-auto uk-margin-left uk-flex uk-flex-column">
						...
						<partials-date-picker class="rounded" @date-set="applyDate"></partials-date-picker>
					</div>
					...
					<div class="uk-width-auto uk-margin-auto-left uk-flex uk-flex-right ">
			...
			<section class="ledger uk-flex uk-flex-column horizontal-scroll" v-show="showLedger">

				<div class="tiny-padding border-bottom">
					<headers-customer-sales></headers-customer-sales>
				</div>
						...
						<div v-else>
							<template v-if="allSales && allSales.length > 0">
								<div class="uk-width-1-1 uk-flex uk-flex-column">
									<sale-record class="tiny-padding"  v-for="(sale,i) in allSales" :key="sale.uuid" :sale="sale" :class="i < (allSales.length - 1) ? 'border-bottom' : ''" @needs-to-refresh="loadSales" :showCustomer="false">
									</sale-record>
									...
									<div class="uk-width-1-1 uk-flex uk-flex-column uk-flex-center uk-flex-middle">
										<div class="uk-flex uk-flex-column uk-flex-center uk-flex-middle">
											...
											<p class="uk-text-center uk-margin-remove-top" v-else>
												Customer purchase records will be displayed here when available.
											</p>
...
<script>
import {bindProps, sales} from "@/mixins/customer"
export default{
	data(){
		return {
			showLedger : true
