<template>
	<div class="background">
		<div class="uk-width-1-1 background uk-flex uk-flex-middle border-bottom tiny-margin-top grid-padding">
		...
		<div class="uk-width-1-1 uk-flex uk-flex-middle tiny-padding border-bottom">
			<div class="grid-gutter uk-margin-auto-right">
						...
						<div class="uk-width-1-1 uk-flex uk-flex-column">
							<div class="tiny-padding" v-for="(supplier, i) in stats" :key="supplier.uuid" :class="i < (stats.length - 1) ? 'border-bottom' : ''">
								...
								<div class="uk-width-1-1 uk-flex uk-flex-middle">
									...
									<div class="grid-gutter uk-width-small  uk-margin-auto-left">
										<nuxt-link v-if="can(['view-suppliers', 'view-purchases'])" class="underlined highlight-text" :to="{name: 'suppliers-supplier', params : {supplier : supplier.uuid}}">
											View Purchases
										</nuxt-link>
									</div>
