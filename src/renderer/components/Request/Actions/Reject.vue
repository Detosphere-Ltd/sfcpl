			...
			<div class="uk-width-1-1 uk-margin-large-top">
				<div class="rounded bordered background raised-deep uk-width-1-1 uk-inline uk-margin-auto uk-width-large@s">
					...
					<div class="uk-width-1-1 modal-content uk-overflow-auto">
						<div class="uk-padding-small">
							<h4 class="uk-margin-remove-top tiny-margin-bottom">
								You are about to reject this stock request
							</h4>
							<p class="uk-margin-remove">
								You are required to provide a reason/comment for rejecting this request. Please note that this action cannot be reversed.
							</p>
						</div>
					...
					<div class="tiny-padding border-top uk-flex uk-flex-center">
						<button class="uk-button uk-button-danger" :disabled="processing || !comments || comments.length < 2" @click="rejectRequest()">
...
<script>
import {base, bindProps , reject} from "@/mixins/requests/singleton"
export default{
	mixins : [base, bindProps , reject],
};
</script>
