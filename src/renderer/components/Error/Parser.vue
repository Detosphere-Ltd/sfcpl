<template>
	<div>
		<div v-if="errorData.response.status === 403"  class="uk-width-1-1 uk-flex uk-flex-column uk-flex-middle">
			<span class="mdi mdi-lock-alert lni-extra-large uk-margin-remove-top uk-margin-small-bottom"></span>
...
<script>
const messages = {
	"403" : `You do not have the right permissions to access this information.`,
