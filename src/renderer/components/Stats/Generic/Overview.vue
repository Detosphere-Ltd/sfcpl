			...
			<div class="uk-width-expand">
				...
				<div>
					<div class="uk-width-auto uk-margin-small-top">
						<partials-date-picker :alignment="emporium.setup_completed ? 'center' : 'right'" @date-set="applyDate"></partials-date-picker>
					</div>
				</div>
			</div>
				...
				<div class="uk-flex uk-flex-wrap  uk-width-1-1" v-if="visible">
					<div class="uk-width-expand uk-flex uk-flex-column">
						...
						<div class="tiny-padding uk-padding-remove-horizontal uk-padding-remove-bottom stat-list uk-flex uk-flex-column">
							...
							<div class="uk-flex uk-flex-middle uk-flex-between stat-item tiny-padding uk-padding-remove-horizontal uk-padding-remove-bottom">
						...
						<!-- 		<nuxt-link :to="{name: 'inventory-purchases', query : {intent: 'pay'}}" class="chip tiny-margin-left uk-background-primary uk-text-white uk-border-rounded" v-if="can(['view-purchases', 'record-purchase-payment']) && stats['Total Amount of Unpaid Purchases'] > 0">
									<span class="text-small">
										Pay Now
									</span>
								</nuxt-link> -->
					...
					<div class="uk-width-expand uk-flex uk-flex-column">
						...
						<div class="tiny-padding uk-padding-remove-horizontal uk-padding-remove-bottom stat-list uk-flex uk-flex-column uk-margin-auto-vertical">
							<div class="uk-flex uk-flex-middle stat-item tiny-padding uk-padding-remove-horizontal uk-padding-remove-bottom">
								<div class="square-40 uk-margin-small-right uk-border-rounded uk-background-primary-op uk-flex uk-flex-column uk-flex-center uk-flex-middle">
