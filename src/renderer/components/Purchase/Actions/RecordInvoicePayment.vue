				...
				<div class="uk-width-1-1 background bordered rounded raised-deep uk-animation-scale-up uk-animation-fast uk-width-medium@s">
					...
					<div class=" uk-overflow-auto modal-content">
						<div class="tiny-padding uk-flex uk-flex-column">
							<span class="uk-text-small uk-margin-small-bottom">Enter how much you want to record as payment for this invoice. You can record a maximum of {{invoice.amount_outstanding | currency(`${emporium.currency} `)}}</span>
							<a-input-number :max="invoice.amount_outstanding" :step="0.01" v-model="repayForm.amount"></a-input-number>
					...
					<div class="tiny-padding border-top uk-flex uk-flex-center">
						<button class="uk-button uk-button-primary" :disabled="!repayForm.amount || !repayForm.payment_mode || loading" @click="recordPayment">
...
<script>
import { bindProps , repay } from "@/mixins/purchase/invoice"
export default{
